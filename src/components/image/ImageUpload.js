...
const ImageUpload = (props) => {
  ...
  return (
    <label
      className={`cursor-pointer flex items-center justify-center border border-orange-200 w-full min-h-[200px] rounded-lg ${className} relative overflow-hidden group`}
    >
      <input
        type="file"
        name={name}
      ...
      {!image && (
        <div
          className="absolute bottom-0 left-0 w-10 h-1 transition-all bg-orange-400 image-upload-progress"
          style={{
